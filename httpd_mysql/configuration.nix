...

{
  ...
  services.httpd.virtualHosts."bismi_allah.local" = {
    documentRoot = "/var/www/bismi_allah.local";
    locations."/".index="bismi_allah.php index.php bismi_allah.html index.html";
